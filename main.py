...
text2 = play.new_text(words = 'Створи свою мелодію натискаючи на клавіши', x = 0, y = 150)

play_melody = play.new_box(color = 'light green',
...
clear_melody = play.new_box(color = 'light green',
    border_color = 'aquamarine',
    border_width = 4,
    x = 100,
    y = -170,
...
def clear_mel():
    melody.clear()
    clear_cnd = pygame.mixer.Sound('clear_melody.wav')
    clear_cnd.play
